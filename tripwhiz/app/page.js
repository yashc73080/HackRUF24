  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <div className="flex-1 flex relative">
        ...
        <div 
          className={`absolute w-96 h-full bg-white shadow-lg flex flex-col z-10 transition-transform duration-300 ${
            ...
            {selectedLocations.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="w-full mt-2 py-2 px-4 text-gray-600 hover:text-gray-900 text-sm"
                >
                  Clear All Locations
                </button>
              </>
        ...
        <div className="flex-1 relative">
          ...
          {!isSidebarOpen && (
            <button
              ...
              className="absolute top-4 left-4 z-20 p-3 bg-white rounded-lg shadow-lg hover:bg-gray-100"
            >
